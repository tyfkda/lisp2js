...
LISP["create-scope"] = (function(parent$2dscope, params){return (LISP.vector(LISP["dotted->proper"](params), LISP.nil, parent$2dscope));});
...
LISP["compile-lambda"] = (function(params, bodies, base$2dscope, extended$2dscope){return ((function(rest$2dpos){return ((function(proper$2dparams, rest){return (LISP["string-append"]("(function(", LISP["string-join"](LISP.map((function(x){return (LISP["escape-symbol"](x));}), proper$2dparams), ", "), "){", (LISP.isTrue(LISP["null?"](rest)) ? ("") : (LISP["string-append"]("var ", LISP["symbol->string"](rest), " = LISP._getRestArgs(arguments, ", LISP["number->string"](LISP.length(proper$2dparams)), "); "))), "return (", LISP["expand-body"](bodies, extended$2dscope), ");})"));})((LISP.isTrue(rest$2dpos) ? (LISP.take(rest$2dpos, params)) : (params)), (LISP.isTrue(rest$2dpos) ? (LISP.elt((rest$2dpos + 1), params)) : (LISP.nil))));})(LISP["position-if"]((function() { var __6 = LISP.list(LISP.intern("&rest"), LISP.intern("&body")); return (function(sym){return (LISP.member(sym, __6));}); })(), params)));});
...
LISP["compile*"] = (function(s, scope){return ((function(__7){return ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":CONST"))) ? (LISP["compile-quote"](LISP["vector-ref"](s, 1), scope)) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":REF"))) ? (LISP["compile-symbol"](LISP["vector-ref"](s, 1), scope)) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":IF"))) ? ((function(p, thn, els){return (LISP["compile-if"](p, thn, els, scope));})(LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), LISP["vector-ref"](s, 3))) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":FUNCALL"))) ? (LISP["compile-funcall"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":SET!"))) ? (LISP["compile-set!"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":LAMBDA"))) ? ((function(extended$2dscope, params, body){return (LISP["compile-new-scope"](extended$2dscope, LISP["compile-lambda"](params, body, scope, extended$2dscope)));})(LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), LISP["vector-ref"](s, 3))) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":DEF"))) ? (LISP["compile-def"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":DEFMACRO"))) ? (LISP["do-compile-defmacro"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2))) : ((LISP.isTrue(LISP["eq?"](__7, LISP.intern(":NEW"))) ? (LISP["compile-new"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : (LISP["string-append"]("???", s, "???"))))))))))))))))))));})(LISP["vector-ref"](s, 0)));});
