...
LISP['register-macro'](LISP.intern("and"), (function() { var __3 = LISP.list(LISP.intern("nil")); return (function(){var args = LISP._getRestArgs(arguments, 0); return ((LISP.isTrue(LISP["null?"](args)) ? (LISP.t) : ((LISP.isTrue(LISP["null?"](LISP.cdr(args))) ? (LISP.car(args)) : (LISP["list*"](LISP.intern("if"), LISP.car(args), LISP["list*"](LISP.intern("and"), LISP.cdr(args)), __3))))));}); })());
