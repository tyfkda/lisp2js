...
LISP['traverse*'] = (function(s, scope){return ((LISP.isTrue(LISP['pair?'](s)) ? ((LISP.isTrue(LISP['local-var?'](scope, LISP.car(s))) ? (LISP['traverse-list'](s, scope)) : ((function(expanded){return ((LISP.isTrue(LISP['pair?'](expanded)) ? (LISP['traverse-list'](expanded, scope)) : (LISP['traverse*'](expanded, scope))));})(LISP.macroexpand(s))))) : ((LISP.isTrue(LISP['symbol?'](s)) ? (LISP.vector(LISP.intern(':REF'), s)) : (LISP.vector(LISP.intern(':CONST'), s))))));});
...
LISP['unary-op?'] = (function() { var __6 = LISP.list(LISP.intern('+'), LISP.intern('-')); return (function(sym){return (LISP.member(sym, __6));}); })();
...
LISP['compile-funcall'] = (function(fn, args, scope){return ((LISP.isTrue((LISP.isTrue(LISP['eq?'](LISP['vector-ref'](fn, 0), LISP.intern(':REF'))) ? ((LISP.isTrue(LISP.not(LISP['local-var?'](scope, LISP['vector-ref'](fn, 1)))) ? (LISP.not(LISP['null?'](args))) : (LISP.nil))) : (LISP.nil))) ? ((function(fnsym){return ((LISP.isTrue((LISP.isTrue(LISP['binop?'](fnsym)) ? (LISP.not(LISP['null?'](LISP.cdr(args)))) : (LISP.nil))) ? (LISP['compile-binop'](fnsym, args, scope)) : ((LISP.isTrue((LISP.isTrue(LISP['unary-op?'](fnsym)) ? (LISP['null?'](LISP.cdr(args))) : (LISP.nil))) ? (LISP['compile-unary-op'](fnsym, LISP.car(args), scope)) : (LISP['do-compile-funcall'](fn, args, scope))))));})(LISP['vector-ref'](fn, 1))) : (LISP['do-compile-funcall'](fn, args, scope))));});
