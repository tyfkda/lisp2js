...
LISP.take = (function(n, ls){return ((function(loop){return (loop = (function(n, ls, acc){return ((LISP.isTrue((function(__7){return ((LISP.isTrue(__7) ? (__7) : ((function(__8){return ((LISP.isTrue(__8) ? (__8) : (LISP.nil)));})(LISP["null?"](ls)))));})(LISP["<="](n, 0))) ? (LISP["reverse!"](acc)) : (loop((n - 1), LISP.cdr(ls), LISP.cons(LISP.car(ls), acc)))));}), loop(n, ls, LISP.nil));})(LISP.nil));});
...
LISP["traverse-list"] = (function(s, scope){return ((function(__2){return ((function(__3){return ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("quote"))) ? (LISP.apply((function(x){return ((LISP.isTrue(LISP["pair?"](x)) ? (LISP.vector(LISP.intern(":REF"), LISP["scope-add-var"](scope, LISP["traverse-quoted-value"](x)))) : (LISP.vector(LISP.intern(":CONST"), x))));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("if"))) ? (LISP.apply((function(p, thn){var els = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":IF"), LISP["traverse*"](p, scope), LISP["traverse*"](thn, scope), (LISP.isTrue(LISP["null?"](els)) ? (LISP.nil) : (LISP["traverse*"](LISP.car(els), scope)))));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("set!"))) ? (LISP.apply((function(x, v){return (LISP.vector(LISP.intern(":SET!"), LISP["traverse*"](x, scope), LISP["traverse*"](v, scope)));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("lambda"))) ? (LISP.apply((function(params){var body = LISP._getRestArgs(arguments, 1); return ((function(new$2dscope){return (LISP.vector(LISP.intern(":LAMBDA"), new$2dscope, params, LISP["traverse-args"](body, new$2dscope)));})(LISP["new-scope"](scope, params)));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("def"))) ? (LISP.apply((function(name, value){var rest = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](value, scope)));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("defun"))) ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](LISP["list*"](LISP.intern("lambda"), params, body), scope)));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("defmacro"))) ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEFMACRO"), name, LISP["list*"](LISP.intern("lambda"), params, body)));}), LISP.cdr(__2))) : ((LISP.isTrue(LISP["eq?"](__3, LISP.intern("new"))) ? (LISP.apply((function(klass){var args = LISP._getRestArgs(arguments, 1); return (LISP.vector(LISP.intern(":NEW"), klass, LISP["traverse-args"](args, LISP["new-scope"])));}), LISP.cdr(__2))) : (LISP.vector(LISP.intern(":FUNCALL"), LISP["traverse*"](LISP.car(s), scope), LISP["traverse-args"](LISP.cdr(s), scope)))))))))))))))))));})(LISP.car(__2)));})(s));});
...
LISP["unary-op?"] = (function() { var __4 = LISP.list(LISP.intern("+"), LISP.intern("-")); return (function(sym){return (LISP.member(sym, __4));}); })();
LISP["compile-unary-op"] = (function(fn, arg, scope){return (LISP["string-append"]("(", LISP["symbol->string"](fn), LISP["compile*"](arg, scope), ")"));});
LISP["binop?"] = (function() { var __5 = LISP.list(LISP.intern("+"), LISP.intern("-"), LISP.intern("*"), LISP.intern("/"), LISP.intern("%")); return (function(sym){return (LISP.member(sym, __5));}); })();
...
LISP["compile-lambda"] = (function(params, bodies, base$2dscope, extended$2dscope){return ((function(rest$2dpos){return ((function(proper$2dparams, rest){return (LISP["string-append"]("(function(", LISP["string-join"](LISP.map((function(x){return (LISP["escape-symbol"](x));}), proper$2dparams), ", "), "){", (LISP.isTrue(LISP["null?"](rest)) ? ("") : (LISP["string-append"]("var ", LISP["symbol->string"](rest), " = LISP._getRestArgs(arguments, ", LISP["number->string"](LISP.length(proper$2dparams)), "); "))), "return (", LISP["expand-body"](bodies, extended$2dscope), ");})"));})((LISP.isTrue(rest$2dpos) ? (LISP.take(rest$2dpos, params)) : ((LISP.isTrue((function(__6){return ((LISP.isTrue(__6) ? (__6) : ((function(__7){return ((LISP.isTrue(__7) ? (__7) : (LISP.nil)));})(LISP["proper-list?"](params)))));})(LISP["null?"](params))) ? (params) : (LISP["reverse!"](LISP.reverse(params)))))), (LISP.isTrue(rest$2dpos) ? ((LISP.isTrue(rest$2dpos) ? (LISP.elt((rest$2dpos + 1), params)) : (LISP.nil))) : ((LISP.isTrue(LISP["pair?"](params)) ? (LISP.cdr(LISP["last-pair"](params))) : (params))))));})(LISP["position-if"]((function() { var __8 = LISP.list(LISP.intern("&rest"), LISP.intern("&body")); return (function(sym){return (LISP.member(sym, __8));}); })(), params)));});
...
LISP["compile*"] = (function(s, scope){return ((function(__9){return ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":CONST"))) ? (LISP["compile-quote"](LISP["vector-ref"](s, 1), scope)) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":REF"))) ? (LISP["compile-symbol"](LISP["vector-ref"](s, 1), scope)) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":IF"))) ? ((function(p, thn, els){return (LISP["compile-if"](p, thn, els, scope));})(LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), LISP["vector-ref"](s, 3))) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":FUNCALL"))) ? (LISP["compile-funcall"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":SET!"))) ? (LISP["compile-set!"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":LAMBDA"))) ? ((function(extended$2dscope, params, body){return (LISP["compile-new-scope"](extended$2dscope, LISP["compile-lambda"](params, body, scope, extended$2dscope)));})(LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), LISP["vector-ref"](s, 3))) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":DEF"))) ? (LISP["compile-def"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":DEFMACRO"))) ? (LISP["do-compile-defmacro"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2))) : ((LISP.isTrue(LISP["eq?"](__9, LISP.intern(":NEW"))) ? (LISP["compile-new"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : (LISP["string-append"]("???", s, "???"))))))))))))))))))));})(LISP["vector-ref"](s, 0)));});
