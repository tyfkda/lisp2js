...
LISP['register-macro'](LISP.intern("let"), (function(pairs){var body = LISP._getRestArgs(arguments, 1); return ((LISP.isTrue(LISP["symbol?"](pairs)) ? ((function() { var __2 = LISP.list(LISP.nil); return (function(name, pairs, body){return (LISP["list*"](LISP.list(LISP.intern("^"), LISP.list(name), LISP.list(LISP.intern("set!"), name, LISP["list*"](LISP.intern("^"), LISP.map(LISP.car, pairs), body)), LISP["list*"](name, LISP.map(LISP.cadr, pairs))), __2));}); })()(pairs, LISP.car(body), LISP.cdr(body))) : (LISP["list*"](LISP["list*"](LISP.intern("^"), LISP.map(LISP.car, pairs), body), LISP.map(LISP.cadr, pairs)))));}));
LISP['register-macro'](LISP.intern("let1"), (function(name, value){var body = LISP._getRestArgs(arguments, 2); return (LISP.list(LISP["list*"](LISP.intern("^"), LISP.list(name), body), value));}));
...
LISP['register-macro'](LISP.intern("record"), (function(args, param){var body = LISP._getRestArgs(arguments, 2); return (LISP.list(LISP.intern("apply"), LISP["list*"](LISP.intern("^"), param, body), args));}));
...
LISP["traverse-list"] = (function(s, scope){return ((function(__3){return ((function(__4){return ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("quote"))) ? (LISP.apply((function(x){return ((LISP.isTrue(LISP["pair?"](x)) ? (LISP.vector(LISP.intern(":REF"), LISP["scope-add-var"](scope, LISP["traverse-quoted-value"](x)))) : (LISP.vector(LISP.intern(":CONST"), x))));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("if"))) ? (LISP.apply((function(p, thn){var els = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":IF"), LISP["traverse*"](p, scope), LISP["traverse*"](thn, scope), (LISP.isTrue(LISP["null?"](els)) ? (LISP.nil) : (LISP["traverse*"](LISP.car(els), scope)))));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("set!"))) ? (LISP.apply((function(x, v){return (LISP.vector(LISP.intern(":SET!"), LISP["traverse*"](x, scope), LISP["traverse*"](v, scope)));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("lambda"))) ? (LISP.apply((function(params){var body = LISP._getRestArgs(arguments, 1); return ((function(new$2dscope){return (LISP.vector(LISP.intern(":LAMBDA"), new$2dscope, params, LISP["traverse-args"](body, new$2dscope)));})(LISP["create-scope"](scope, params)));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("^"))) ? (LISP.apply((function(params){var body = LISP._getRestArgs(arguments, 1); return ((function(new$2dscope){return (LISP.vector(LISP.intern(":LAMBDA"), new$2dscope, params, LISP["traverse-args"](body, new$2dscope)));})(LISP["create-scope"](scope, params)));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("def"))) ? (LISP.apply((function(name, value){return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](value, scope)));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("defun"))) ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](LISP["list*"](LISP.intern("^"), params, body), scope)));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("defmacro"))) ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEFMACRO"), name, LISP["list*"](LISP.intern("^"), params, body)));}), LISP.cdr(__3))) : ((LISP.isTrue(LISP["eq?"](__4, LISP.intern("new"))) ? (LISP.apply((function(klass){var args = LISP._getRestArgs(arguments, 1); return (LISP.vector(LISP.intern(":NEW"), klass, LISP["traverse-args"](args, LISP["new-scope"])));}), LISP.cdr(__3))) : (LISP.vector(LISP.intern(":FUNCALL"), LISP["traverse*"](LISP.car(s), scope), LISP["traverse-args"](LISP.cdr(s), scope)))))))))))))))))))));})(LISP.car(__3)));})(s));});
...
LISP["unary-op?"] = (function() { var __5 = LISP.list(LISP.intern("+"), LISP.intern("-")); return (function(sym){return (LISP.member(sym, __5));}); })();
LISP["compile-unary-op"] = (function(fn, arg, scope){return (LISP["string-append"]("(", LISP["symbol->string"](fn), LISP["compile*"](arg, scope), ")"));});
LISP["binop?"] = (function() { var __6 = LISP.list(LISP.intern("+"), LISP.intern("-"), LISP.intern("*"), LISP.intern("/"), LISP.intern("%")); return (function(sym){return (LISP.member(sym, __6));}); })();
...
LISP["compile-lambda"] = (function(params, bodies, base$2dscope, extended$2dscope){return ((LISP.isTrue((function(__7){return ((LISP.isTrue(__7) ? (__7) : ((function(__8){return ((LISP.isTrue(__8) ? (__8) : (LISP.nil)));})(LISP["pair?"](params)))));})(LISP["null?"](params))) ? (LISP.nil) : (LISP.error("function parameters must be a list"))), (function(rest$2dpos){return ((function(proper$2dparams, rest){return (LISP["string-append"]("(function(", LISP["string-join"](LISP.map((function(x){return (LISP["escape-symbol"](x));}), proper$2dparams), ", "), "){", (LISP.isTrue(LISP["null?"](rest)) ? ("") : (LISP["string-append"]("var ", LISP["symbol->string"](rest), " = LISP._getRestArgs(arguments, ", LISP["number->string"](LISP.length(proper$2dparams)), "); "))), "return (", LISP["expand-body"](bodies, extended$2dscope), ");})"));})((LISP.isTrue(rest$2dpos) ? (LISP.take(rest$2dpos, params)) : (params)), (LISP.isTrue(rest$2dpos) ? (LISP.elt((rest$2dpos + 1), params)) : (LISP.nil))));})(LISP["position-if"]((function() { var __9 = LISP.list(LISP.intern("&rest"), LISP.intern("&body")); return (function(sym){return (LISP.member(sym, __9));}); })(), params)));});
