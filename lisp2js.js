...
LISP["compile-lambda"] = (function(params, bodies, base$2dscope, extended$2dscope){return ((LISP.isTrue((function(__7){return ((LISP.isTrue(__7) ? (__7) : (LISP["pair?"](params))));})(LISP["null?"](params))) ? (LISP.nil) : (LISP.error("function parameters must be a list"))), (function(rest$2dpos){return ((function(proper$2dparams, rest){return (LISP["string-append"]("(function(", LISP["string-join"](LISP.map((function(x){return (LISP["escape-symbol"](x));}), proper$2dparams), ", "), "){", (LISP.isTrue(LISP["null?"](rest)) ? ("") : (LISP["string-append"]("var ", LISP["escape-symbol"](rest), " = LISP._getRestArgs(arguments, ", LISP["number->string"](LISP.length(proper$2dparams)), "); "))), "return (", LISP["expand-body"](bodies, extended$2dscope), ");})"));})((LISP.isTrue(rest$2dpos) ? (LISP.take(rest$2dpos, params)) : (params)), (LISP.isTrue(rest$2dpos) ? (LISP.elt((rest$2dpos + 1), params)) : (LISP.nil))));})(LISP["position-if"]((function() { var __8 = LISP.list(LISP.intern("&rest"), LISP.intern("&body")); return (function(sym){return (LISP.member(sym, __8));}); })(), params)));});
