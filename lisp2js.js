...
LISP['register-macro'](LISP.intern("unless"), (function(pred){var body = LISP._getRestArgs(arguments, 1); return (LISP.list(LISP.intern("if"), pred, LISP.nil, LISP["list*"](LISP.intern("begin"), body)));}));
LISP['register-macro'](LISP.intern("cond"), (function(){var clauses = LISP._getRestArgs(arguments, 0); return ((LISP.isTrue(LISP["null?"](clauses)) ? (LISP.nil) : ((function(clause, rest){return ((LISP.isTrue((function(__3){return ((LISP.isTrue(__3) ? (__3) : ((function(__4){return ((LISP.isTrue(__4) ? (__4) : (LISP.nil)));})(LISP["eq?"](LISP.car(clause), LISP.t)))));})(LISP["eq?"](LISP.car(clause), LISP.intern("else")))) ? (LISP["list*"](LISP.intern("begin"), LISP.cdr(clause))) : ((LISP.isTrue(LISP["null?"](LISP.cdr(clause))) ? ((function(g){return (LISP.list(LISP.intern("let"), LISP.list(LISP.list(g, LISP.car(clause))), LISP.list(LISP.intern("if"), g, g, LISP["list*"](LISP.intern("cond"), rest))));})(LISP.gensym())) : ((LISP.isTrue(LISP["eq?"](LISP.cadr(clause), LISP.intern("=>"))) ? ((function(g){return (LISP.list(LISP.intern("let"), LISP.list(LISP.list(g, LISP.car(clause))), LISP.list(LISP.intern("if"), g, LISP.list(LISP.caddr(clause), g), LISP["list*"](LISP.intern("cond"), rest))));})(LISP.gensym())) : (LISP.list(LISP.intern("if"), LISP.car(clause), LISP["list*"](LISP.intern("begin"), LISP.cdr(clause)), LISP["list*"](LISP.intern("cond"), rest)))))))));})(LISP.car(clauses), LISP.cdr(clauses)))));}));
LISP['register-macro'](LISP.intern("case"), (function(x){var clauses = LISP._getRestArgs(arguments, 1); return ((function(value){return (LISP.list(LISP.intern("let1"), value, x, LISP["list*"](LISP.intern("cond"), LISP.map((function(clause){return ((LISP.isTrue((function(__5){return ((LISP.isTrue(__5) ? (__5) : ((function(__6){return ((LISP.isTrue(__6) ? (__6) : (LISP.nil)));})(LISP["eq?"](LISP.car(clause), LISP.t)))));})(LISP["eq?"](LISP.car(clause), LISP.intern("else")))) ? (clause) : ((LISP.isTrue(LISP["null?"](LISP.cdar(clause))) ? (LISP["list*"](LISP.list(LISP.intern("eq?"), value, LISP.list(LISP.intern("quote"), LISP.caar(clause))), LISP.cdr(clause))) : (LISP["list*"](LISP.list(LISP.intern("member"), value, LISP.list(LISP.intern("quote"), LISP.car(clause))), LISP.cdr(clause)))))));}), clauses))));})(LISP.gensym()));}));
LISP['register-macro'](LISP.intern("and"), (function() { var __7 = LISP.list(LISP.nil); return (function(){var args = LISP._getRestArgs(arguments, 0); return ((LISP.isTrue(LISP["null?"](args)) ? (LISP.t) : ((LISP.isTrue(LISP["null?"](LISP.cdr(args))) ? (LISP.car(args)) : (LISP["list*"](LISP.intern("if"), LISP.car(args), LISP["list*"](LISP.intern("and"), LISP.cdr(args)), __7))))));}); })());
...
LISP["equal?"] = (function(x, y){return ((LISP.isTrue(LISP["eq?"](x, y)) ? (LISP.t) : ((function(xtype){return ((LISP.isTrue(LISP["eq?"](xtype, LISP.type(y))) ? ((function(__8){return ((LISP.isTrue(LISP["eq?"](__8, LISP.intern("pair"))) ? ((LISP.isTrue(LISP["equal?"](LISP.car(x), LISP.car(y))) ? (LISP["equal?"](LISP.cdr(x), LISP.cdr(y))) : (LISP.nil))) : ((LISP.isTrue(LISP["eq?"](__8, LISP.intern("vector"))) ? ((function(n){return ((LISP.isTrue(LISP["eq?"](n, LISP["vector-length"](y))) ? ((function(loop){return (loop = (function(i){return ((function(__9){return ((LISP.isTrue(__9) ? (__9) : ((function(__10){return ((LISP.isTrue(__10) ? (__10) : (LISP.nil)));})((LISP.isTrue(LISP["equal?"](LISP["vector-ref"](x, i), LISP["vector-ref"](y, i))) ? (loop((i + 1))) : (LISP.nil))))));})(LISP[">="](i, n)));}), loop(0));})(LISP.nil)) : (LISP.nil)));})(LISP["vector-length"](x))) : (LISP.nil)))));})(xtype)) : (LISP.nil)));})(LISP.type(x)))));});
...
LISP.take = (function(n, ls){return ((function(loop){return (loop = (function(n, ls, acc){return ((LISP.isTrue((function(__11){return ((LISP.isTrue(__11) ? (__11) : ((function(__12){return ((LISP.isTrue(__12) ? (__12) : (LISP.nil)));})(LISP["null?"](ls)))));})(LISP["<="](n, 0))) ? (LISP["reverse!"](acc)) : (loop((n - 1), LISP.cdr(ls), LISP.cons(LISP.car(ls), acc)))));}), loop(n, ls, LISP.nil));})(LISP.nil));});
LISP.drop = (function(n, ls){return ((LISP.isTrue((function(__13){return ((LISP.isTrue(__13) ? (__13) : ((function(__14){return ((LISP.isTrue(__14) ? (__14) : (LISP.nil)));})(LISP["null?"](ls)))));})(LISP["<="](n, 0))) ? (ls) : (LISP.drop((n - 1), LISP.cdr(ls)))));});
...
LISP["bq-splicing-frob"] = (function(x){return ((LISP.isTrue(LISP["pair?"](x)) ? ((function(__2){return ((LISP.isTrue(__2) ? (__2) : ((function(__3){return ((LISP.isTrue(__3) ? (__3) : (LISP.nil)));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-dot"))))));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-splicing")))) : (LISP.nil)));});
LISP["bq-frob"] = (function(x){return ((LISP.isTrue(LISP["pair?"](x)) ? ((function(__4){return ((LISP.isTrue(__4) ? (__4) : ((function(__5){return ((LISP.isTrue(__5) ? (__5) : ((function(__6){return ((LISP.isTrue(__6) ? (__6) : (LISP.nil)));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-dot"))))));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-splicing"))))));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote")))) : (LISP.nil)));});
...
LISP["null-or-quoted"] = (function(x){return ((function(__7){return ((LISP.isTrue(__7) ? (__7) : ((function(__8){return ((LISP.isTrue(__8) ? (__8) : (LISP.nil)));})((LISP.isTrue(LISP["pair?"](x)) ? (LISP["eq?"](LISP.car(x), LISP.intern("quote"))) : (LISP.nil))))));})(LISP["null?"](x)));});
LISP["bq-attach-append"] = (function(op, item, result){return ((LISP.isTrue((LISP.isTrue(LISP["null-or-quoted"](item)) ? (LISP["null-or-quoted"](result)) : (LISP.nil))) ? (LISP.list(LISP.intern("quote"), LISP.append(LISP.cadr(item), LISP.cadr(result)))) : ((LISP.isTrue((function(__9){return ((LISP.isTrue(__9) ? (__9) : ((function(__10){return ((LISP.isTrue(__10) ? (__10) : (LISP.nil)));})(LISP["equal?"](result, LISP["*bq-quote-nil*"])))));})(LISP["null?"](result))) ? ((LISP.isTrue(LISP["bq-splicing-frob"](item)) ? (LISP.list(op, item)) : (item))) : ((LISP.isTrue((LISP.isTrue(LISP["pair?"](result)) ? (LISP["eq?"](LISP.car(result), op)) : (LISP.nil))) ? (LISP["list*"](LISP.car(result), item, LISP.cdr(result))) : (LISP.list(op, item, result))))))));});
LISP["bq-attach-conses"] = (function(items, result){return ((LISP.isTrue((LISP.isTrue(LISP.every(LISP["null-or-quoted"], items)) ? (LISP["null-or-quoted"](result)) : (LISP.nil))) ? (LISP.list(LISP.intern("quote"), LISP.append(LISP.map(LISP.cadr, items), LISP.cadr(result)))) : ((LISP.isTrue((function(__11){return ((LISP.isTrue(__11) ? (__11) : ((function(__12){return ((LISP.isTrue(__12) ? (__12) : (LISP.nil)));})(LISP["equal?"](result, LISP["*bq-quote-nil*"])))));})(LISP["null?"](result))) ? (LISP.cons(LISP.intern("list"), items)) : ((LISP.isTrue((LISP.isTrue(LISP["pair?"](result)) ? ((function(__13){return ((LISP.isTrue(__13) ? (__13) : ((function(__14){return ((LISP.isTrue(__14) ? (__14) : (LISP.nil)));})(LISP["eq?"](LISP.car(result), LISP.intern("list*"))))));})(LISP["eq?"](LISP.car(result), LISP.intern("list")))) : (LISP.nil))) ? (LISP.cons(LISP.car(result), LISP.append(items, LISP.cdr(result)))) : (LISP.cons(LISP.intern("list*"), LISP.append(items, LISP.list(result))))))))));});
...
LISP["traverse-list"] = (function(s, scope){return ((function(__5){return ((function(__6){return ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("quote"))) ? (LISP.apply((function(x){return ((LISP.isTrue(LISP["pair?"](x)) ? (LISP.vector(LISP.intern(":REF"), LISP["scope-add-var"](scope, LISP["traverse-quoted-value"](x)))) : (LISP.vector(LISP.intern(":CONST"), x))));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("if"))) ? (LISP.apply((function(p, thn){var els = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":IF"), LISP["traverse*"](p, scope), LISP["traverse*"](thn, scope), (LISP.isTrue(LISP["null?"](els)) ? (LISP.nil) : (LISP["traverse*"](LISP.car(els), scope)))));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("set!"))) ? (LISP.apply((function(x, v){return (LISP.vector(LISP.intern(":SET!"), LISP["traverse*"](x, scope), LISP["traverse*"](v, scope)));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("lambda"))) ? (LISP.apply((function(params){var body = LISP._getRestArgs(arguments, 1); return ((function(new$2dscope){return (LISP.vector(LISP.intern(":LAMBDA"), new$2dscope, params, LISP["traverse-args"](body, new$2dscope)));})(LISP["create-scope"](scope, params)));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("def"))) ? (LISP.apply((function(name, value){return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](value, scope)));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("defun"))) ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](LISP["list*"](LISP.intern("lambda"), params, body), scope)));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("defmacro"))) ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEFMACRO"), name, LISP["list*"](LISP.intern("lambda"), params, body)));}), LISP.cdr(__5))) : ((LISP.isTrue(LISP["eq?"](__6, LISP.intern("new"))) ? (LISP.apply((function(klass){var args = LISP._getRestArgs(arguments, 1); return (LISP.vector(LISP.intern(":NEW"), klass, LISP["traverse-args"](args, LISP["new-scope"])));}), LISP.cdr(__5))) : (LISP.vector(LISP.intern(":FUNCALL"), LISP["traverse*"](LISP.car(s), scope), LISP["traverse-args"](LISP.cdr(s), scope)))))))))))))))))));})(LISP.car(__5)));})(s));});
...
(function(table){return (LISP["hash-table-put!"](table, "\\", "\\\\"), LISP["hash-table-put!"](table, "\t", "\\t"), LISP["hash-table-put!"](table, "\n", "\\n"), LISP["hash-table-put!"](table, "\"", "\\\""), LISP["escape-char"] = (function(c){return ((function(it){return ((LISP.isTrue(it) ? (it) : (c)));})(LISP["hash-table-get"](table, c)));}));})(LISP["make-hash-table"]());
...
LISP["unary-op?"] = (function() { var __7 = LISP.list(LISP.intern("+"), LISP.intern("-")); return (function(sym){return (LISP.member(sym, __7));}); })();
LISP["compile-unary-op"] = (function(fn, arg, scope){return (LISP["string-append"]("(", LISP["symbol->string"](fn), LISP["compile*"](arg, scope), ")"));});
LISP["binop?"] = (function() { var __8 = LISP.list(LISP.intern("+"), LISP.intern("-"), LISP.intern("*"), LISP.intern("/"), LISP.intern("%")); return (function(sym){return (LISP.member(sym, __8));}); })();
...
LISP["compile-lambda"] = (function(params, bodies, base$2dscope, extended$2dscope){return ((LISP.isTrue((function(__9){return ((LISP.isTrue(__9) ? (__9) : ((function(__10){return ((LISP.isTrue(__10) ? (__10) : (LISP.nil)));})(LISP["pair?"](params)))));})(LISP["null?"](params))) ? (LISP.nil) : (LISP.error("function parameters must be a list"))), (function(rest$2dpos){return ((function(proper$2dparams, rest){return (LISP["string-append"]("(function(", LISP["string-join"](LISP.map((function(x){return (LISP["escape-symbol"](x));}), proper$2dparams), ", "), "){", (LISP.isTrue(LISP["null?"](rest)) ? ("") : (LISP["string-append"]("var ", LISP["symbol->string"](rest), " = LISP._getRestArgs(arguments, ", LISP["number->string"](LISP.length(proper$2dparams)), "); "))), "return (", LISP["expand-body"](bodies, extended$2dscope), ");})"));})((LISP.isTrue(rest$2dpos) ? (LISP.take(rest$2dpos, params)) : (params)), (LISP.isTrue(rest$2dpos) ? (LISP.elt((rest$2dpos + 1), params)) : (LISP.nil))));})(LISP["position-if"]((function() { var __11 = LISP.list(LISP.intern("&rest"), LISP.intern("&body")); return (function(sym){return (LISP.member(sym, __11));}); })(), params)));});
...
LISP["compile*"] = (function(s, scope){return ((function(__12){return ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":CONST"))) ? (LISP["compile-quote"](LISP["vector-ref"](s, 1), scope)) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":REF"))) ? (LISP["compile-symbol"](LISP["vector-ref"](s, 1), scope)) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":IF"))) ? ((function(p, thn, els){return (LISP["compile-if"](p, thn, els, scope));})(LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), LISP["vector-ref"](s, 3))) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":FUNCALL"))) ? (LISP["compile-funcall"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":SET!"))) ? (LISP["compile-set!"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":LAMBDA"))) ? ((function(extended$2dscope, params, body){return (LISP["compile-new-scope"](extended$2dscope, LISP["compile-lambda"](params, body, scope, extended$2dscope)));})(LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), LISP["vector-ref"](s, 3))) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":DEF"))) ? (LISP["compile-def"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":DEFMACRO"))) ? (LISP["do-compile-defmacro"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2))) : ((LISP.isTrue(LISP["eq?"](__12, LISP.intern(":NEW"))) ? (LISP["compile-new"](LISP["vector-ref"](s, 1), LISP["vector-ref"](s, 2), scope)) : (LISP["string-append"]("???", s, "???"))))))))))))))))))));})(LISP["vector-ref"](s, 0)));});
