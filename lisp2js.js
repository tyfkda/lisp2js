...
LISP["equal?"] = (function(x, y){return (((LISP["eq?"](x, y)) !== LISP.nil ? (LISP.t) : ((function(xtype){return (((LISP["eq?"](xtype, LISP.type(y))) !== LISP.nil ? ((function(__4){return (((LISP["eq?"](__4, LISP.intern("pair"))) !== LISP.nil ? (((LISP["equal?"](LISP.car(x), LISP.car(y))) !== LISP.nil ? (LISP["equal?"](LISP.cdr(x), LISP.cdr(y))) : (LISP.nil))) : (((LISP["eq?"](__4, LISP.intern("vector"))) !== LISP.nil ? ((function(n){return (((LISP["eq?"](n, LISP["vector-length"](y))) !== LISP.nil ? ((function(loop){return (loop = (function(i){return ((function(__5){return (((__5) !== LISP.nil ? (__5) : ((function(__6){return (((__6) !== LISP.nil ? (__6) : (LISP.nil)));})(((LISP["equal?"](LISP["vector-ref"](x, i), LISP["vector-ref"](y, i))) !== LISP.nil ? (loop((i + 1))) : (LISP.nil))))));})(LISP[">="](i, n)));}), loop(0));})(LISP.nil)) : (LISP.nil)));})(LISP["vector-length"](x))) : (LISP.nil)))));})(xtype)) : (LISP.nil)));})(LISP.type(x)))));});
...
LISP["bq-splicing-frob"] = (function(x){return (((LISP["pair?"](x)) !== LISP.nil ? ((function(__7){return (((__7) !== LISP.nil ? (__7) : ((function(__8){return (((__8) !== LISP.nil ? (__8) : (LISP.nil)));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-dot"))))));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-splicing")))) : (LISP.nil)));});
LISP["bq-frob"] = (function(x){return (((LISP["pair?"](x)) !== LISP.nil ? ((function(__9){return (((__9) !== LISP.nil ? (__9) : ((function(__10){return (((__10) !== LISP.nil ? (__10) : ((function(__11){return (((__11) !== LISP.nil ? (__11) : (LISP.nil)));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-dot"))))));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote-splicing"))))));})(LISP["eq?"](LISP.car(x), LISP.intern("unquote")))) : (LISP.nil)));});
...
LISP["null-or-quoted"] = (function(x){return ((function(__12){return (((__12) !== LISP.nil ? (__12) : ((function(__13){return (((__13) !== LISP.nil ? (__13) : (LISP.nil)));})(((LISP["pair?"](x)) !== LISP.nil ? (LISP["eq?"](LISP.car(x), LISP.intern("quote"))) : (LISP.nil))))));})(LISP["null?"](x)));});
LISP["bq-attach-append"] = (function(op, item, result){return (((((LISP["null-or-quoted"](item)) !== LISP.nil ? (LISP["null-or-quoted"](result)) : (LISP.nil))) !== LISP.nil ? (LISP.list(LISP.intern("quote"), LISP.append(LISP.cadr(item), LISP.cadr(result)))) : ((((function(__14){return (((__14) !== LISP.nil ? (__14) : ((function(__15){return (((__15) !== LISP.nil ? (__15) : (LISP.nil)));})(LISP["equal?"](result, LISP["*bq-quote-nil*"])))));})(LISP["null?"](result))) !== LISP.nil ? (((LISP["bq-splicing-frob"](item)) !== LISP.nil ? (LISP.list(op, item)) : (item))) : (((((LISP["pair?"](result)) !== LISP.nil ? (LISP["eq?"](LISP.car(result), op)) : (LISP.nil))) !== LISP.nil ? (LISP["list*"](LISP.car(result), item, LISP.cdr(result))) : (LISP.list(op, item, result))))))));});
LISP["bq-attach-conses"] = (function(items, result){return (((((LISP.every(LISP["null-or-quoted"], items)) !== LISP.nil ? (LISP["null-or-quoted"](result)) : (LISP.nil))) !== LISP.nil ? (LISP.list(LISP.intern("quote"), LISP.append(LISP.map(LISP.cadr, items), LISP.cadr(result)))) : ((((function(__16){return (((__16) !== LISP.nil ? (__16) : ((function(__17){return (((__17) !== LISP.nil ? (__17) : (LISP.nil)));})(LISP["equal?"](result, LISP["*bq-quote-nil*"])))));})(LISP["null?"](result))) !== LISP.nil ? (LISP.cons(LISP.intern("list"), items)) : (((((LISP["pair?"](result)) !== LISP.nil ? ((function(__18){return (((__18) !== LISP.nil ? (__18) : ((function(__19){return (((__19) !== LISP.nil ? (__19) : (LISP.nil)));})(LISP["eq?"](LISP.car(result), LISP.intern("list*"))))));})(LISP["eq?"](LISP.car(result), LISP.intern("list")))) : (LISP.nil))) !== LISP.nil ? (LISP.cons(LISP.car(result), LISP.append(items, LISP.cdr(result)))) : (LISP.cons(LISP.intern("list*"), LISP.append(items, LISP.list(result))))))))));});
...
LISP["traverse-list"] = (function(s, scope){return ((function(__20){return ((function(__21){return (((LISP["eq?"](__21, LISP.intern("quote"))) !== LISP.nil ? (LISP.apply((function(x){return (((LISP["pair?"](x)) !== LISP.nil ? (LISP.vector(LISP.intern(":REF"), LISP["scope-add-var"](scope, LISP["traverse-quoted-value"](x)))) : (LISP.vector(LISP.intern(":CONST"), x))));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("if"))) !== LISP.nil ? (LISP.apply((function(p, thn){var els = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":IF"), LISP["traverse*"](p, scope), LISP["traverse*"](thn, scope), ((LISP["null?"](els)) !== LISP.nil ? (LISP.nil) : (LISP["traverse*"](LISP.car(els), scope)))));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("set!"))) !== LISP.nil ? (LISP.apply((function(x, v){return (LISP.vector(LISP.intern(":SET!"), LISP["traverse*"](x, scope), LISP["traverse*"](v, scope)));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("lambda"))) !== LISP.nil ? (LISP.apply((function(params){var body = LISP._getRestArgs(arguments, 1); return ((function(new$2dscope){return (LISP.vector(LISP.intern(":LAMBDA"), new$2dscope, params, LISP["traverse-args"](body, new$2dscope)));})(LISP["new-scope"](scope, params)));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("def"))) !== LISP.nil ? (LISP.apply((function(name, value){var rest = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](value, scope)));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("defun"))) !== LISP.nil ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEF"), LISP["traverse*"](name, scope), LISP["traverse*"](LISP["list*"](LISP.intern("lambda"), params, body), scope)));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("defmacro"))) !== LISP.nil ? (LISP.apply((function(name, params){var body = LISP._getRestArgs(arguments, 2); return (LISP.vector(LISP.intern(":DEFMACRO"), name, LISP["list*"](LISP.intern("lambda"), params, body)));}), LISP.cdr(__20))) : (((LISP["eq?"](__21, LISP.intern("new"))) !== LISP.nil ? (LISP.apply((function(klass){var args = LISP._getRestArgs(arguments, 1); return (LISP.vector(LISP.intern(":NEW"), klass, LISP["traverse-args"](args, LISP["new-scope"])));}), LISP.cdr(__20))) : (LISP.vector(LISP.intern(":FUNCALL"), LISP["traverse*"](LISP.car(s), scope), LISP["traverse-args"](LISP.cdr(s), scope)))))))))))))))))));})(LISP.car(__20)));})(s));});
