...
LISP["compile-defmacro"] = (function(s, env){return ((function(name, params, body){return ((function(exp){return (((LISP["*run-on-js*"]) !== LISP.nil ? ((function(compiled){return (LISP["register-macro"](name, LISP.jseval(compiled)), LISP["string-append"]("LISP['register-macro'](", compiled, ")"));})(LISP.compile(exp))) : ((LISP["hash-table-put!"](LISP["*macro-table*"], name, LISP.eval(exp, LISP["interaction-environment"]())), LISP["string-append"]("/*", LISP["symbol->string"](name), "*/ LISP.nil")))));})(LISP["list*"](LISP.intern("lambda"), params, body)));})(LISP.caar(s), LISP.cdar(s), LISP.cdr(s)));});
